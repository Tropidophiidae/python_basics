...
def capitalize_line(_line):
    # capitalize all the character after dot
    capitalized_line = capitalize_after_dot(_line)
    # capitalize first character in the line
    capitalized_line = capitalize_first_char_in_the_line(capitalized_line)
    return capitalized_line if capitalized_line is not None else _line
...
for i, line in enumerate(homework_lines):
    homework_lines[i] = capitalize_line(line)
